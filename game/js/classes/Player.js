...
class Player {
    ...
    update() {
        ...
        if (this.HP < this.maxHP && this.mode !== "Dead" && this.mode !== "Dying" ) {
        ...
        crates.forEach(crate => {
            if (crate.position.x < this.position.x + this.width &&
                ...
                crate.position.y >= this.position.y + this.height - 10 && this.isjumping === false && this.mode !== "Dying" && this.mode !== "Dead") {
        ...
        this.isjumping = false
        if (keys.uparrow.pressed === true && this.velocity.y === 0 && this.jumped > 0 && this.mode !== "dying" && this.mode !== "Dead") {
